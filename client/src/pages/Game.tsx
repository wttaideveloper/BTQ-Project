...
const Game: React.FC = () => {
  ...
  const [gameId] = useState(() => {
    const existingId = params.get('gameId') || sessionStorage.getItem('currentGameId');
    if (existingId) return existingId;
    
    const newId = gameMode === 'multi' ? 
  ...
  const { data: questions, isLoading, error } = useQuery({
    ...
    queryFn: () => getGameQuestions(category, difficulty, gameType === 'question' ? 10 : 20, gameId),

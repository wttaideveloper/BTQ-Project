    ...
    items: [
      {
        ...
        answer:
          'Tap "Solo Quiz" on the home screen, pick Question-Based (10 questions, 20 sec each) or Time-Based (5, 10, or 15-minute round), then choose your category and difficulty. Hit Start Solo Quiz and you\'re in!',
      },
      {

    ...
    <div className="flex-grow flex flex-col bg-black rounded-3xl shadow-2xl overflow-hidden relative border-2 border-accent">
      ...
      <div className="p-3 sm:p-5 md:p-8 flex-grow flex flex-col bg-gradient-to-b from-black to-primary-dark/30">
        <div className="mb-4 sm:mb-6 md:mb-8 text-center bg-secondary/20 p-3 sm:p-4 md:p-5 rounded-xl border border-secondary/30">
          <h2
            className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-white mb-2 sm:mb-3 reveal-animation"
          ...
          {questionContext && (
            <p
              className="text-white/80 text-sm sm:text-base italic reveal-animation"
          ...
          {answers.map((answer, index) => (
            ...
            >
              ...
              {isQuestionAnswered && answer.isCorrect && (
                <span className="ml-1 bg-green-500 rounded-full w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0 flex items-center justify-center text-white">
                  ✓
                </span>
              )}
              {isQuestionAnswered &&
                ...
                !answer.isCorrect && (
                  <span className="ml-1 bg-red-500 rounded-full w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0 flex items-center justify-center text-white">
                    ✗
                  </span>
                )}
            </button>

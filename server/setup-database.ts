...
async function setupDatabase() {
  ...
  try {
    ...
    // Step 1: Connect as postgres user to create application user and database
    console.log("📋 Step 1: Connecting as postgres user...");
    client = postgres("postgresql://postgres@localhost:5432/postgres");
    ...
    const appClient = postgres("postgresql://faithiq_user:faithiq_password123@localhost:5432/bible_trivia_db");
